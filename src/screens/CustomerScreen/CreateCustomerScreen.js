...
const CreateCustomerScreen = (store) => {
        ...
        return (<View style={[appStyle.container, {backgroundColor: "white"}]}>
            <ScrollView>
                ...
                <View style={{borderWidth: 1, marginVertical: 10, borderRadius: 5}}>
                    <RadioButton.Group onValueChange={value => setStudentType(value)} value={studentType}>
                        <RadioButton.Item label="Tiềm năng" value="0"/>
                        <RadioButton.Item label="Không tiềm năng" value="1"/>
                        <RadioButton.Item label="Chưa học thử" value="2"/>
                    </RadioButton.Group>
                </View>
                {/*<TextInput*/}
                {/*    label={"Avatar"}*/}
...
export default connect(state => ({store: state}))(CreateCustomerScreen);
